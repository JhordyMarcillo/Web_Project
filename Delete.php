		...
		<section class="full-width header-well">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					<h3 style="margin-top: 8%; margin-left: 10%"> Eliminar Usuarios</h3>
				</p>
			</div>
		</section>
<div class="mdl-grid">
            ...
            <div class="full-width panel-content">
                ...
                <form method="GET" action="">
                    ...
                    <div class="mdl-textfield mdl-js-textfield">
                        <select class="mdl-textfield__input" id="filterStatus" name="status">
                        ...
                        <label class="mdl-textfield__label" for="filterStatus">Estado</label>
                    </div>
                    <button type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored">Buscar</button>
                </form>
                ...
                <div class="mdl-list" style="width: 80%">
                    ...
                    $status = isset($_GET['status']) ? $_GET['status'] : 'Activo';
                    $sql = "SELECT id, cedula, nombre, apellido, direccion, telefono, correo, estadoCivil, fechaNacimiento, estado FROM cliente WHERE estado = '$status'";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            $actionLabel = $status == 'Activo' ? 'Eliminar' : 'Activar';
                            $actionLink = "DeleteSQL.php?id=" . $row["id"] . "&status=" . $status;
                            echo "<tr>
                                    <td>" . $row["cedula"] . "</td>
                                    <td>" . $row["nombre"] . "</td>
                                    <td>" . $row["apellido"] . "</td>
